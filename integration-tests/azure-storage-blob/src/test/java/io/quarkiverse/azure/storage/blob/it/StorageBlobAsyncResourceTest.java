    ...
    void shouldUploadATextfile() throws InterruptedException {
        ...
        try {
            ...
            given()
                    .when()
                    .body(body)
                    .post("/quarkus-azure-storage-blob-async/" + container + "/" + blobName)
                    .then()
                    .statusCode(201);

            // Read
            given()
                    .when().get("/quarkus-azure-storage-blob-async/" + container + "/" + blobName)
                    .then()
                    .statusCode(200)
                    .body(is(body));
            ...
            // List
            given()
                    .when().get("/quarkus-azure-storage-blob-async/" + container)
                    .then()
                    .statusCode(200)
            ...
            given()
                    .when()
                    .delete("/quarkus-azure-storage-blob-async/" + container + "/" + blobName)
                    .then()
                    .statusCode(204);

            given()
                    .when()
                    .head("/quarkus-azure-storage-blob-async/" + container + "/" + blobName)
                    .then()
                    .statusCode(404);
        }
    }
