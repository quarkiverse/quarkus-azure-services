...
* Create and retrieve secret from Azure Key Vault by injecting the following object in a Quarkus application.
...
You can load and reference secrets from Azure Key Vault in your application.properties file by using the following syntax:
