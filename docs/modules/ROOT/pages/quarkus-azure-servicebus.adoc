...
=== Dev Services Tutorial

See this https://github.com/quarkiverse/quarkus-azure-services/tree/main/integration-tests/azure-servicebus-devservices[tutorial project]
for how to take full advatage of the Azure Service Bus Dev Services.
