...
This extension allows you to produce and consume messages from Azure Service Bus by creating Service Bus clients with injected `com.azure.messaging.servicebus.ServiceBusClientBuilder` object in your Quarkus application.
